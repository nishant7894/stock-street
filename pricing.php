...
<body>
   ...
   <?php
	...
	<div class="navbar-nav py-0 justify-content-between">
                            ...
                            <a href="disclaimer.php" class="nav-item nav-link">Disclaimer</a>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 90px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Pricing</h3>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mb-5">
                <h5 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;">Pricing</h5>
                <h1>Our Popular Pricing</h1>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="rounded overflow-hidden mb-2">
                        ...
                        <div class="bg-secondary p-4">
                            ...
                            <a class="h5" href="">Web design & development Pricing for beginner</a>
